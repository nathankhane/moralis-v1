...
const HEADER_LOGO = "/logos/Bridge_Logo-removebg-preview.png"
const FOOTER_LOGO = "/logos/Bridge_Logo-removebg-preview.png"

// Expert Profile (Bridge experts only)
...
- Updated all booking links from `calendly.com/trustedapp/30min` to `cal.com/bridgenow/30min`
...
## 🌉 Bridge Logo Implementation (Added Sept 24, 2025)

### Logo Components Quick Reference
- Header: <Logo /> (uses Black/White Logo.svg horizontally)  
- Footer: <LogoVertical /> (uses Black/White Logo Vertical 2.svg)
- Icons: <LogoIcon /> (uses Black/White Icon.svg for compact spaces)

### Critical Sizing Rules
- Header: h-8 w-auto (maintains 3.2:1 aspect ratio)
- Footer: h-16 w-auto (maintains 1.23:1 aspect ratio) 
- Icons: h-6 w-6 or h-8 w-8 (square)
- ALWAYS use w-auto to prevent distortion

### Files Location
All Bridge logos in: public/logos/Bridge/
- Black Logo.svg & White Logo.svg (768×240px horizontal)
- Black Logo Vertical 2.svg & White Logo Vertical 2.svg (535×435px vertical)
- Black Icon.svg & White Icon.svg (183×184px square)
