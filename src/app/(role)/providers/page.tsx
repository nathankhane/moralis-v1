    ...
    return (
        <div className="min-h-screen">
            ...
            <RoleHero
                ...
                ctaLabel="Book Demo"
                ctaHref="https://cal.com/bridgenow/discoverycall"
            />
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-muted-foreground">
                            How companies are using Bridge to accelerate growth
                        </p>
                    </div>
            ...
            <RealUserWall
                ...
                subtitle="Companies using Bridge to accelerate product decisions"
            />
