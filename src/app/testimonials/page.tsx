...
export default function TestimonialsPage() {
  ...
  const expertTestimonials = [
    ...
    },
    {
      ...
      quote: "Hiring agencies for user research felt like burning money in slow-motion—weeks of screening, and the &apos;insights&apos; barely moved the needle. One Bridge campaign put 35 power users of our biggest competitor in front of my PMs this week. We trimmed two sprints of guess-work, closed six net-new accounts straight from the calls, and paid less than one agency retainer. Bridge is now baked into every launch checklist.",
    },
    {
      name: "Aisha Rahman",
      ...
      quote: "Bridge turned my product opinions into a side-income stream in a weekend. Three discovery calls, $900 in my Stripe balance, zero cold outreach. Finally—my expertise gets paid, not just praised.",
    },
    {
      name: "Sophia Lorenzo",
      ...
      quote: "Bridge surfaces tools that actually solve my clients' problems. I demo, get paid, and grab lifetime discounts all in one workflow—chef's kiss.",
    },
    {
      name: "Javier Ortega",
      title: "CTO, SeedLoop",
    ...
    },
    {
      ...
      quote: "I dreaded 'expert networks' until I scored two early-access tools through Bridge. Post-review, both founders kept me on retainer for growth advice. Double win.",
    },
  ];
  const providerTestimonials = [
    ...
    },
    {
      ...
      fallback: "NS",
      color: avatarColors[5],
      quote: "User-generated video reviews straight from Bridge tripled our social proof overnight. No influencer fluff—real operators, real use-cases.",
    },
    {
      name: "Dr. Rina Patel",
    ...
    },
    {
      ...
      quote: "We're a security startup; NDAs are life. Bridge's built-in legal shield meant zero red-line cycles. Signed, paid, scheduled—all before my coffee cooled.",
    },
  ];
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center">
              ...
              <p className="text-body mt-6">
                Real stories from founders and experts who use Bridge to unlock new value.
              </p>
            </div>
        ...
        <div className="pt-6 md:pt-10 pb-16 md:pb-24">
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center">
              ...
              <p className="text-body mt-6">
                Real stories from SaaS partners who use Bridge to unlock new value.
              </p>
            </div>
            <div className="mt-8 grid gap-3 sm:grid-cols-2 md:mt-12 lg:grid-cols-3">
      ...
      <div className="mt-16 text-center mb-16">
        ...
        >
          <Button asChild variant="outline" className="hover:scale-105 transition-transform duration-200 hover:shadow-md">
            <Link href="https://cal.com/bridgenow/discoverycall" target="_blank" rel="noopener noreferrer">Become a Vendor</Link>
          </Button>
          <Button asChild className="hover:scale-105 transition-transform duration-200 hover:shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
            <Link href="https://cal.com/bridgenow/discoverycall" target="_blank" rel="noopener noreferrer">Join as a Founder</Link>
          </Button>
        </motion.div>
      </div>
    </div>
