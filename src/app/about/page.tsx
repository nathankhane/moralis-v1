    ...
    return (
        <main className="mx-auto max-w-5xl px-4 lg:px-6 py-16 space-y-24 leading-relaxed">
            ...
            <section className="border-l-4 pl-6 border-primary/70">
                <p className="italic">
                    &ldquo;Bridge put 35 competitor power-users in front of our PMs in four days.
            ...
            <section className="space-y-4 max-w-3xl">
                <h2 className="text-2xl font-semibold">Why we built Bridge</h2>
                <p>
                    ...
                    Bridge so builders learn faster <em>and</em> the people who already love their
            ...
            <footer className="text-center text-sm text-muted-foreground">
                Bridge (part of Only Founders, Inc) — 380 C Street, Hayward, CA&nbsp;94541 ·{' '}
