...
export default function ResultCard() {
    ...
    const waterfallItems = [
        { label: 'Base Rate', value: baseRate * lengthMultiplier, percentage: basePercentage, color: 'gradient-primary' },
        { label: 'Add-ons', value: baseRate * lengthMultiplier * (addOnMultiplier - 1), percentage: addOnPercentage, color: 'bg-gradient-to-r from-green-400 to-emerald-500' },
        { label: 'Stage Bonus', value: baseRate * lengthMultiplier * addOnMultiplier * (stageMultiplier - 1), percentage: stagePercentage, color: 'bg-gradient-to-r from-purple-400 to-pink-500' },
        { label: 'Rush Fee', value: rushFee, percentage: rushPercentage, color: 'bg-gradient-to-r from-orange-400 to-red-500' },
    ].filter(item => item.value > 0);

    return (
        <TooltipProvider>
            <Card className="sticky top-24 h-fit bg-card border">
                <CardHeader>
                    <CardTitle className="text-center gradient-text">Revenue Projection</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4 pt-4 border-t">
                        ...
                        <div className="flex justify-between items-center pt-3 border-t bg-muted/50 p-3 rounded-lg">
