...
type Persona = "company" | "expert";

// Hero copy data
const heroCopy = {
  expert: {
    heading: "Monetize your product insight, instantly.",
    sub: "Bridge pipes paid calls and surveys from the SaaS tools you already use. Cash hits Stripe right after you share."
  },
  company: {
...
> = {
  company: tiles.company.map(tile => ({
    title: tile.title,
...
export default function FeaturesSection() {
  ...
  const persona: Persona =
    searchParams.get("persona") === "company" ? "company" : "expert"; // default expert
