      ...
      <header className="fixed inset-x-0 top-0 z-[80] w-full px-4 lg:px-6">
        ...
        >
          <div className={cn(
            ...
            <div className={cn(
              "flex items-center justify-between lg:relative transition-all duration-500",
          ...
          <div className="relative z-[75] flex flex-col h-full">
            ...
            <div className="flex-1 px-6 py-8">
              ...
              <div className="mt-12 space-y-4">
                ...
                >
                  <Link href="https://cal.com/bridgenow/discoverycall" target="_blank" rel="noopener noreferrer" onClick={closeMobileMenu}>Login</Link>
                </Button>
                <Button
                  asChild
                ...
                >
                  <Link href="https://cal.com/bridgenow/discoverycall" target="_blank" rel="noopener noreferrer" onClick={closeMobileMenu}>Sign Up</Link>
                </Button>
              </div>
            </div>
