...
export default function FooterSection() {
  return (
    <footer className="bg-muted/50 border-t py-12 mt-0">
      <div className="max-w-3xl mx-auto flex flex-col items-center">
        <LogoVertical className="mb-6" />
        <nav className="flex flex-wrap justify-center gap-6 mb-8 text-sm font-medium text-muted-foreground">
          <Link href="https://cal.com/bridgenow/discoverycall" className="hover:text-foreground transition-colors" target="_blank" rel="noopener noreferrer">
            Contact Us
          </Link>
        ...
        <span className="text-muted-foreground text-sm">
          © {new Date().getFullYear()} Bridge (part of Only Founders, Inc). All rights reserved
        </span>
      </div>
    </footer>
  );
