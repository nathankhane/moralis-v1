...
const expertFaq = [
  ...
  },
  {
    ...
    a: 'No. Joining is free and Bridge only takes 10 % after the Provider approves your work.',
  },
  {
    q: 'Can I also be a Provider?',
    a: 'Yes—one account, dual roles. Many Experts use Bridge for competitor insight while monetising their own expertise.',
  },
];
          ...
          <div className="inline-flex rounded-full bg-muted p-1">
            {(['expert', 'provider'] as const).map((tab) => (
              <button
                ...
                className={cn(
                  "px-4 sm:px-6 py-2 text-sm sm:text-base font-medium rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                  activeTab === tab
